...
/*3º: definir funções que serão utilizadas no projeto (elas são definidas aqui, pois melhora a visualização do código como um todo)
* Como visto no datasheet do microcontrolador, para trabalharmos com uma das GPIO, devemos utilizar a função DDRB, que funciona da seguinte forma:
*
...
*
* traduzindo para um pseudo-código: reg |= (1<<bit)
*/
